<%@ Control Language="C#" AutoEventWireup="false" Inherits="IgorKarpov.Modules.DocumentsExchangeModule.Settings" Codebehind="Settings.ascx.cs" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DocumentsExchangeModule Settings Design Table">
    <tr>
