<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditDocumentsExchangeModule.ascx.cs" Inherits="IgorKarpov.Modules.DocumentsExchangeModule.EditDocumentsExchangeModule" %>
